...
function AdminDashboardPage() {
  ...
  const [autoApprove, setAutoApprove] = useState(
    () => localStorage.getItem("adminAutoApproveSchools") === "true"
  );
    ...
    try {
      ...
      if (responseText.trim()) {
        try {
          ...
          console.error(
            "Automatic approval invalid JSON:",
            responseText
          );
        }
      }
    ...
    try {
      ...
      if (responseText.trim()) {
        try {
          ...
          console.error(
            "Auto approval status invalid JSON:",
            responseText
          );
        }
      }
      ...
      if (!response.ok || !result?.success) {
        throw new Error(
          result?.message ||
            "تعذر جلب حالة الموافقة التلقائية."
        );
      }
      ...
      console.error(
        "Fetch auto approval status failed:",
        error
      );
    }
  };
      ...
      if (firstRequestsLoad.current) {
        ...
        const newRequests = requests.filter(
          (request) =>
            ...
            !knownRequestIds.current.has(request.id)
        );
        ...
        for (const request of newRequests) {
          ...
          if (autoApproveRef.current) {
            await approveAutomatically(request);
          }
        }
      }
    ...
    try {
      ...
      if (responseText.trim()) {
        try {
          ...
          console.error(
            "Auto approval update invalid JSON:",
            responseText
          );
        }
      }
      ...
      if (!response.ok || !result?.success) {
        throw new Error(
          result?.message ||
            "تعذر تغيير حالة الموافقة التلقائية."
        );
      }
      ...
      setAutoApprove(serverEnabled);
      autoApproveRef.current = serverEnabled;

      localStorage.setItem(
        "adminAutoApproveSchools",
        String(serverEnabled)
      );
            ...
            <>
              ...
              <div className="admin-page-heading">
                ...
                <div>
                  ...
                  <p>
                    مراجعة الطلبات الفعلية الواردة من المدارس.
                  </p>
                </div>
              ...
              >
                ...
                <div>
                  ...
                  >
                    عند التفعيل، سيتم قبول طلبات المدارس الجديدة تلقائيًا باستخدام نظام الموافقة الحالي.
                  </p>
                ...
                <label
                  style={{
                    ...
                    display: "inline-flex",
                    alignItems: "center",
                    cursor: autoApproveLoading
                      ? "wait"
                      : "pointer",
                    flexShrink: "0",
                    opacity: autoApproveLoading
                      ? 0.6
                      : 1
                  }}
                >
              ...
              {loading ? (
                ...
                <div className="admin-empty-state">
                  ...
                  <p>
                    ستظهر هنا طلبات المدارس التي تنتظر موافقة المسير.
                  </p>
                </div>
              ) : (
          ...
          {activeSection === "schools" && (
            <div className="admin-page-heading">
              ...
              <div>
                <h2>المدارس</h2>
                <p>
                  انتقل إلى صفحة المدارس المسجلة لإدارتها.
                </p>
              </div>
          ...
          >
            ...
            <div className="admin-modal-header">
              ...
              <div>
                ...
                <p>
                  مراجعة البيانات قبل اتخاذ القرار
                </p>
              </div>
